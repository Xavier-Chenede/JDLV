...
animate(anim, duration = 10 , fps = 10, width = 600, height = 600, renderer = gifski_renderer())

#keep last gen as gen_0

continue <- aggreg[,,z_dim]
continue 
dim(continue)
...
# test <- matrix(inp,nrow=size,ncol=size)
# test
# plot(test, key=NULL)
# 
# plot(aggreg[5,5,10])
